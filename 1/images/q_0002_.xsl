	...
	<style>
			...
			<xsl:when test="display_bg='yes'">
				<xsl:choose>
					<xsl:when test="$theme='simple'">
						.cl-outer { position: relative; width: <xsl:value-of select="number($width) - 2"/>px; height: <xsl:value-of select="number($height) - 2"/>px; border-style: solid; border-width: 1px; border-color: <xsl:value-of select="$border-color-outer-simple"/>; <xsl:if test="$_shadow_string!=''">box-shadow: <xsl:value-of select="$_shadow_string"/>;</xsl:if> }
						.cl-middle { position: relative; width: <xsl:value-of select="number($width) - 6"/>px; height: <xsl:value-of select="number($height) - 6"/>px; border-style: solid; border-width: 2px; border-color: <xsl:value-of select="$border-color-main-simple"/>; }
						.cl-inner { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; background-color: <xsl:value-of select="$bg-color-simple"/>; border-style: solid; border-width: 1px; border-color: <xsl:value-of select="$border-color-inner-simple"/>; padding: <xsl:value-of select="padding"/>px; }
						.cl-table-plain { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; border-spacing: 0; }
						.cl-table-plain-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
						.cl-table-scale { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; border-spacing: 0; }
						.cl-table-scale-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; padding: 0; }
					...
					<xsl:when test="$theme='standard'">
						.cl-outer { position: relative; width: <xsl:value-of select="number($width) - 4"/>px; height: <xsl:value-of select="number($height) - 4"/>px; border-style: solid; border-width: 2px; background-color: <xsl:value-of select="$bg-color-standard"/>; border-color: <xsl:value-of select="$border-color-standard"/>; border-radius: 10px; <xsl:if test="$_shadow_string!=''">box-shadow: <xsl:value-of select="$_shadow_string"/>;</xsl:if> }
						.cl-middle { position: relative; width: inherit; height: inherit;  }
						.cl-inner { position: relative; width: inherit; height: inherit; padding: <xsl:value-of select="padding"/>px;  }
						.cl-table-plain { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; border-spacing: 0; }
						.cl-table-plain-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
						.cl-table-scale { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; border-spacing: 0; }
						.cl-table-scale-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; }
						.cl-results-container { position: relative; overflow-y: scroll; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
					</xsl:when>
					<xsl:when test="$theme='light'">
						.cl-outer { position: relative; width: <xsl:value-of select="number($width) - 2"/>px; height: <xsl:value-of select="number($height) - 2"/>px; border-style: solid; border-width: 1px; background-color: <xsl:value-of select="$bg-color-light"/>; border-color: <xsl:value-of select="$border-color-light"/>; border-radius: 5px; <xsl:if test="$_shadow_string!=''">box-shadow: <xsl:value-of select="$_shadow_string"/>;</xsl:if> }
						.cl-middle { position: relative; width: inherit; height: inherit; }
						.cl-inner { position: relative; width: inherit; height: inherit; padding: <xsl:value-of select="padding"/>px; }
						.cl-table-plain { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; border-spacing: 0; }
						.cl-table-plain-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
						.cl-table-scale { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; border-spacing: 0; }
						.cl-table-scale-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; }
						.cl-results-container { position: relative; overflow-y: scroll; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
					</xsl:when>
				</xsl:choose>
			</xsl:when>
			<xsl:otherwise>
				<xsl:choose>
					<xsl:when test="display_type='plain'">
						<xsl:choose>
							<xsl:when test="$theme='simple'">
								.cl-outer { position: relative; width: <xsl:value-of select="number($width) - 2"/>px; height: <xsl:value-of select="number($height) - 2"/>px; border-style: solid; border-width: 1px; border-color: transparent; }
								.cl-middle { position: relative; width: <xsl:value-of select="number($width) - 6"/>px; height: <xsl:value-of select="number($height) - 6"/>px; border-style: solid; border-width: 2px; border-color: transparent; }
								.cl-inner { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; border-style: solid; border-width: 1px; border-color: transparent; padding: <xsl:value-of select="padding"/>px; }
								.cl-table-plain { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; border-spacing: 0; }
								.cl-table-plain-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
								.cl-table-scale { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; border-spacing: 0; }
								.cl-table-scale-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 8"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 8"/>px; padding: 0; }
							...
							<xsl:when test="$theme='standard'">
								.cl-outer { position: relative; width: <xsl:value-of select="number($width) - 4"/>px; height: <xsl:value-of select="number($height) - 4"/>px; border-style: solid; border-width: 2px; border-color: transparent; border-radius: 10px; }
								.cl-middle { position: relative; width: inherit; height: inherit;  }
								.cl-inner { position: relative; width: inherit; height: inherit; padding: <xsl:value-of select="padding"/>px;  }
								.cl-table-plain { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; border-spacing: 0; }
								.cl-table-plain-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 4"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 4"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
							...
							<xsl:when test="$theme='light'">
								.cl-outer { position: relative; width: <xsl:value-of select="number($width) - 2"/>px; height: <xsl:value-of select="number($height) - 2"/>px; border-style: solid; border-width: 1px; border-color: transparent; border-radius: 5px; }
								.cl-middle { position: relative; width: inherit; height: inherit; }
								.cl-inner { position: relative; width: inherit; height: inherit; padding: <xsl:value-of select="padding"/>px; }
								.cl-table-plain { position: relative; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; border-spacing: 0; }
								.cl-table-plain-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="number($width) - 2*number(padding) - 2"/>px; height: <xsl:value-of select="number($height) - 2*number(padding) - 2"/>px; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
					...
					<xsl:otherwise>
						.cl-outer, .cl-middle, .cl-inner { position: relative; width: <xsl:value-of select="$width"/>px; height: <xsl:value-of select="$height"/>px; padding: 0; }
						.cl-table-scale { position: relative; width: <xsl:value-of select="$width"/>px; height: <xsl:value-of select="$height"/>px; border-spacing: 0; }
						.cl-table-scale-td { vertical-align: middle; text-align: center; width: <xsl:value-of select="$width"/>px; height: <xsl:value-of select="$height"/>px; }
					</xsl:otherwise>
				</xsl:choose>
			</xsl:otherwise>
		</xsl:choose>
		<xsl:choose>
			<xsl:when test="display_type='scale'">
				...
				.cl-table-scale-h { border-spacing: 0; margin: 0 auto; }
				.cl-table-scale-h-desc { width: 50%; padding: <xsl:value-of select="0.5*number(interscale)"/>px <xsl:value-of select="interscale"/>px; text-align: right; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
				.cl-table-scale-h-scale { width: 50%; padding: <xsl:value-of select="0.5*number(interscale)"/>px 0; text-align: left; }
				.cl-table-scale-h-value { white-space: nowrap; padding: <xsl:value-of select="0.5*number(interscale)"/>px <xsl:value-of select="interscale"/>px; text-align: left; font-family: <xsl:value-of select="$_font_family"/>; font-size: <xsl:value-of select="font_size"/>px; <xsl:if test="font_style='bold' or font_style='bolditalic'">font-weight: bold;</xsl:if><xsl:if test="font_style='italic' or font_style='bolditalic'">font-style: italic;</xsl:if> }
				.cl-table-scale-h-div { position: relative; width: 100%; height: <xsl:value-of select="font_size"/>px; border-radius: <xsl:value-of select="0.5*number(font_size)"/>px; background-color: <xsl:value-of select="$scale-color-fixed"/>; background-image: linear-gradient(180deg, <xsl:value-of select="$scale-color-fixed"/> 0%, <xsl:value-of select="$_scale_gradient_color"/> 100%); }
				<xsl:for-each select="scoreboards/item">		
					...
					.cl-table-scale-h-desc-<xsl:value-of select="position()"/> { <xsl:choose><xsl:when test="../../font_color_type='by_scale'">color: <xsl:value-of select="$score-color-fixed"/>;</xsl:when><xsl:otherwise>color: <xsl:value-of select="$font-color-fixed"/>;</xsl:otherwise></xsl:choose> }
					.cl-table-scale-h-scale-<xsl:value-of select="position()"/> { <xsl:choose><xsl:when test="../../font_color_type='by_scale'">color: <xsl:value-of select="$score-color-fixed"/>;</xsl:when><xsl:otherwise>color: <xsl:value-of select="$font-color-fixed"/>;</xsl:otherwise></xsl:choose> }
					.cl-table-scale-h-scale-<xsl:value-of select="position()"/> .cl-table-scale-h-ind { position: relative; width: 50%; height: <xsl:value-of select="../../font_size"/>px; border-radius: <xsl:value-of select="0.5*number(../../font_size)"/>px; background-color: <xsl:value-of select="$score-color-fixed"/>; background-image: linear-gradient(0deg, <xsl:value-of select="$score-color-fixed"/> 0%, <xsl:value-of select="$_gradient_color"/> 100%); overflow: hidden; }
					.cl-table-scale-h-value-<xsl:value-of select="position()"/> { <xsl:choose><xsl:when test="../../font_color_type='by_scale'">color: <xsl:value-of select="$score-color-fixed"/>;</xsl:when><xsl:otherwise>color: <xsl:value-of select="$font-color-fixed"/>;</xsl:otherwise></xsl:choose> }
				</xsl:for-each>
			</xsl:when>
			<xsl:when test="display_type='detail'">
				.cl-results-q-template { border-color: <xsl:value-of select="$border-color-fixed"/>; border-radius: 3px; }
				.cl-results-q-template .cl-results-header .cl-results-header-title { color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-results-q-template .cl-results-header .cl-results-na { color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-results-q-template .cl-results-header .cl-results-header-score-div { background-color: <xsl:value-of select="$bg-color-fixed"/>; color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-switch-group { fill: <xsl:value-of select="$border-color-fixed"/>;}
				
				.cl-results-q-text { background-color: <xsl:value-of select="$bg-color-fixed"/>; border-color: <xsl:value-of select="$border-color-fixed"/>; color: <xsl:value-of select="$border-color-fixed"/>; }

				.cl-results-stats { border-color: <xsl:value-of select="$border-color-fixed"/>; color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-stats-obj-table td { border-color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-stats-obj-header { background-color: <xsl:value-of select="$bg-color-fixed"/>; }

				.cl-results-variants { border-color: <xsl:value-of select="$border-color-fixed"/>; color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-results-q-variants-table td { border-color: <xsl:value-of select="$border-color-fixed"/>; }
				.cl-results-q-variants-header { background-color: <xsl:value-of select="$bg-color-fixed"/>; }
			</xsl:when>
		</xsl:choose>
	</style>

	<div>
		<xsl:attribute name="class">clo-q_0002 container cl-theme-<xsl:value-of select="$theme"/></xsl:attribute>
		<div>
					...
					<xsl:choose>
						...
						<xsl:when test="display_type='detail'">
							<div>
								...
								<xsl:choose>
									<xsl:when test="count(objects/item)=0"><xsl:value-of select="hidden.no.objects"/></xsl:when>
									<xsl:otherwise>
										<div>
											<xsl:attribute name="class">cl-results-q-template</xsl:attribute>
											<div>
											...
											<div>
												...
												<xsl:if test="display_statistics='yes'">
													<div>
														<xsl:attribute name="class">cl-results-stats</xsl:attribute>
														<div>
												...
												<xsl:if test="display_variants='yes'">
													<div>
														<xsl:attribute name="class">cl-results-variants</xsl:attribute>
														<div>
														...
														<div>
															<xsl:attribute name="class">cl-results-contents</xsl:attribute>
															<table>
																<xsl:attribute name="class">cl-results-q-variants-table  cl-results-q-choice-table</xsl:attribute>
																<tr>
																	<td>
																		<xsl:attribute name="colspan">2</xsl:attribute>
																		<xsl:attribute name="class">cl-results-q-variants-header</xsl:attribute>
																		<xsl:value-of select="text_constant_youranswer"/>
																	</td>
																	<xsl:if test="display_corrects='yes'">
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-header</xsl:attribute>
																			<xsl:value-of select="text_constant_correct"/>
																		</td>
																	</xsl:if>
																</tr>
																<tr>
																	<td>
																		<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-selected <xsl:if test="display_corrects='yes'"> cl-results-mark-correct cl-results-correct</xsl:if></xsl:attribute>
																		&#10003;
																	</td>
																	<td>
																		<xsl:attribute name="class">cl-results-q-variants-text cl-results-var-selected <xsl:if test="display_corrects='yes'">cl-results-correct</xsl:if></xsl:attribute>
																		<xsl:choose>
																			<xsl:when test="display_corrects='yes'"><xsl:value-of select="hidden.question_variant_correct"/></xsl:when>
																			<xsl:otherwise><xsl:value-of select="hidden.question_variant_selected"/></xsl:otherwise>
																		</xsl:choose>
																	</td>
																	<xsl:if test="display_corrects='yes'">
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-correct cl-results-correct</xsl:attribute>
																			&#10003;
																		</td>
																	</xsl:if>
																</tr>
																<xsl:if test="display_corrects='yes'">
																	<tr>
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-selected cl-results-mark-incorrect cl-results-incorrect</xsl:attribute>
																			&#10007;
																		</td>
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-text cl-results-var-selected cl-results-incorrect</xsl:attribute>
																			<xsl:value-of select="hidden.question_variant_incorrect"/>
																		</td>
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-correct cl-results-correct</xsl:attribute>
																			&#10003;
																...
																<tr>
																	<td>
																		<xsl:attribute name="class">cl-results-q-variants-mark <xsl:if test="display_corrects='yes'">cl-results-incorrect</xsl:if></xsl:attribute>
																		&#160;
																	</td>
																	<td>
																		<xsl:attribute name="class">cl-results-q-variants-text cl-results-var-unselected <xsl:if test="display_corrects='yes'">cl-results-incorrect</xsl:if></xsl:attribute>
																		<xsl:value-of select="hidden.question_variant_unselected"/>
																	</td>
																	<xsl:if test="display_corrects='yes'">
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-correct cl-results-correct</xsl:attribute>
																...
																<xsl:if test="display_corrects='yes'">
																	<tr>
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-empty cl-results-correct</xsl:attribute>
																			&#160;
																		</td>
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-text cl-results-var-unselected cl-results-correct</xsl:attribute>
																			<xsl:value-of select="hidden.question_variant_unselected"/>
																		</td>
																		<td>
																			<xsl:attribute name="class">cl-results-q-variants-mark cl-results-mark-empty cl-results-correct</xsl:attribute>
